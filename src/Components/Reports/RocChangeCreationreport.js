...
const RocChargeCreationReport = ({ isDropped }) => {
    ...
    const handleGenerateReport = async () => {
        ...
        try {
            ...
            const res = await fetch(`${API_URL}/generate-Rocchangecreation`, {
                method: "POST",
                headers: {
            ...
            a.download = `Roc_Charge_Creation_Report.${extension}`;
            a.click();
        } catch (err) {
...
export default RocChargeCreationReport;
