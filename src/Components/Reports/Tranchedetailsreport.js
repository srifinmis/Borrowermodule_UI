...
const TrancheDetailsReport = ({ isDropped }) => {
  ...
  const generateReport = async () => {
    ...
    const reportParams = { startDate, endDate, sanctionId, lenderCode, format };

    try {
      const response = await fetch(`http://localhost:5002/generate-tranche-details-report`, {
        method: 'POST',
...
export default TrancheDetailsReport;
