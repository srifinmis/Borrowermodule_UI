...
const DateWiseLoanRepaymentReport = ({ isDropped }) => {
  ...
  const generateReport = async () => {
    ...
    const reportParams = { startDate, endDate, format };

    try {
      const response = await fetch(`http://localhost:5002/generate-datewise-loan-repayment-report`, {
        method: 'POST',
  ...
  return (
    <Box sx={{
      ...
      <Typography sx={{
        ...
        Date Wise Loan Repayment Report
      </Typography>
...
export default DateWiseLoanRepaymentReport;
